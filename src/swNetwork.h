...
///
/// \brief WebSocket Network server.
///

class WebNetworkServer : public NetworkServer
{
public:
  ...
  static WebNetworkServer* alloc(NetworkServerCallback* pCallback);
  ...
  static void free(WebNetworkServer* pItf);
};
